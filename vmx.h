...
#define VMX_VMFUNC_CTRL1_SUPPORTED_BITS (__rdmsr1(0x491))
...
#define VMX_MSR_VMX_BASIC (__rdmsr1(0x480))
...
#define VMX_MSR_VMX_PINBASED_CTRLS (__rdmsr1(0x481))
...
// --------------------------------
#define VMX_MSR_VMX_TRUE_PINBASED_CTRLS (__rdmsr1(0x48d))
...
#define VMX_MSR_VMX_PROCBASED_CTRLS (__rdmsr1(0x482))
...
#define VMX_MSR_VMX_TRUE_PROCBASED_CTRLS (__rdmsr1(0x48e))
...
#define VMX_MSR_VMX_VMEXIT_CTRLS (__rdmsr1(0x483))
// Allowed 0-settings (must be '1 bits)
...
#define VMX_MSR_VMX_TRUE_VMEXIT_CTRLS (__rdmsr1(0x48f))
...
#define VMX_MSR_VMX_VMENTRY_CTRLS (__rdmsr1(0x484))
// Allowed 0-settings (must be '1 bits)
...
#define VMX_MSR_VMX_TRUE_VMENTRY_CTRLS (__rdmsr1(0x490))
...
#define VMX_MSR_MISC (__rdmsr1(0x485))
...
#define VMX_MSR_CR0_FIXED0 (__rdmsr1(0x486))

// allowed 1-setting in CR0 in VMX mode
#define VMX_MSR_CR0_FIXED1 (__rdmsr1(0x487))
...
#define VMX_MSR_CR4_FIXED0 (__rdmsr1(0x488))

// allowed 1-setting in CR0 in VMX mode
#define VMX_MSR_CR4_FIXED1 (__rdmsr1(0x489))
...
// -----------------------------
#define VMX_MSR_VMX_PROCBASED_CTRLS2 (__rdmsr1(0x48b))
...
#define VMX_MSR_VMX_EPT_VPID_CAP (__rdmsr1(0x48c))

#endif

// IA32_MSR_EFER MSR (0x485)
// -----------------
// #define MSR_EFER (__rdmsr1(0xc0000080))
